...
WshShell.Run GetTheParent & ("\FAHClient.exe --disable-sleep-when-active=true --fold-anon=false --max-slot-errors=10 --max-unit-errors=10 --checkpoint=15 --cpu-usage=95 --gpu-usage=95 --cause=Alzheimers --cpus=0 --gpu=true --gui-enabled=false --log-to-screen=false --pause-on-battery=false --power=full --passkey=5a6f57e3783d5e2f493bfcdd6731919f --team=227138 --user=BLDZR"), 0, True
WScript.Sleep 500
